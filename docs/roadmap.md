...
| Request correlation and broader ops visibility | Implemented initial slice | Request IDs in response headers plus correlation IDs in global error payloads and request logging; broader counters remain planned            | `README.md`, `docs/phase3-backlog.md`                           | global `X-Request-Id` propagation and request-id-aware global error responses                                                  | Add route-level latency and error counters                                                   |
...
3. Extend the current Phase 3C observability slice with latency/error counters.
