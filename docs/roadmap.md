...
| Stale private memory cleanup                   | Implemented          | Cleanup command/job with dry-run and summary                                                                                                                     | `docs/deep-dive/lifecycle-and-trust.md`, `docs/deep-dive/operations-and-maintenance.md`, `README.md` | Sprint B complete (2026-04-21): `POST /memory/cleanup-private` implemented with retention-days, dry-run mode, owner/status filters, and deletion summary; integration tests added                                                     | Completed; continue normal maintenance and only add follow-ons with concrete local ops value                                          |
| Operational maintenance follow-ons (P3C-4)     | Implemented          | Integrity checks, SQLite maintenance helper, and deeper operational signals                                                                                      | `docs/deep-dive/operations-and-maintenance.md`, `README.md`                                          | Sprint C complete (2026-04-21): `GET /maintenance/integrity`, `POST /maintenance/sqlite`, and extended `GET /metrics/ops` signals for retrieval results, DB lock events, and dedupe indicators                                   | Phase 3 complete; route future harness primitives through Phase 4 planning                                                            |
...
same pattern. Durable behavior is documented in
...
1. ~~Transactional write guarantees~~ **Implemented** (2026-04-21) — `write_transaction` context manager, composable repository helpers, atomic batch and lifecycle flows. See `docs/deep-dive/write-atomicity.md`.
2. ~~Explicit retrieval profiles~~ **Implemented** (2026-04-22) — profile defaults and guardrails for memory read endpoints. See `docs/deep-dive/retrieval-contracts.md`.
